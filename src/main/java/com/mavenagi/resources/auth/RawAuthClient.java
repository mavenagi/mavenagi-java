...
public class RawAuthClient {
     ...
     */
    public MavenAGIHttpResponse<SessionTokenResponse> sessionToken(SessionTokenRequest request) {
     ...
     * you don’t want to expose your API key.
     */
    public MavenAGIHttpResponse<SessionTokenResponse> sessionToken(
