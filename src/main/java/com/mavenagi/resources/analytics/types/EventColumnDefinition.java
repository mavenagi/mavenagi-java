...
@JsonDeserialize(builder = EventColumnDefinition.Builder.class)
public final class EventColumnDefinition implements IColumnDefinitionBase {
    ...
    private EventColumnDefinition(String header, EventMetric metric, Map<String, Object> additionalProperties) {
        this.header = header;
        this.metric = metric;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventColumnDefinition && equalTo((EventColumnDefinition) other);
    }
    ...
    private boolean equalTo(EventColumnDefinition other) {
    ...
    public interface HeaderStage {
        ...
        Builder from(EventColumnDefinition other);
    }
    ...
    public static final class Builder implements HeaderStage, MetricStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(EventColumnDefinition other) {
        ...
        @java.lang.Override
        public EventColumnDefinition build() {
            return new EventColumnDefinition(header, metric, additionalProperties);
        }
    }
}
