...
public final class InboxItemIgnoreRequest {
    ...
    private InboxItemIgnoreRequest(String appId, InboxItemType itemType, Map<String, Object> additionalProperties) {
        this.appId = appId;
    ...
    public static final class Builder implements AppIdStage, ItemTypeStage, _FinalStage {
        ...
        public InboxItemIgnoreRequest build() {
            return new InboxItemIgnoreRequest(appId, itemType, additionalProperties);
        }
    }
}
