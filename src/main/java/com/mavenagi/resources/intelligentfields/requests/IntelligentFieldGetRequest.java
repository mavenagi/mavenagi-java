...
@JsonDeserialize(builder = IntelligentFieldGetRequest.Builder.class)
public final class IntelligentFieldGetRequest {
    ...
    /**
     * @return The App ID of the intelligent field to get. If not provided the ID of the calling app will be used.
     */
    @JsonProperty("appId")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof IntelligentFieldGetRequest && equalTo((IntelligentFieldGetRequest) other);
    }
    ...
    public static final class Builder {
        ...
        /**
         * <p>The App ID of the intelligent field to get. If not provided the ID of the calling app will be used.</p>
         */
