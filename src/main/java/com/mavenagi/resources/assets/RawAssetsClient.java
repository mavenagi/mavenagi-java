...
public class RawAssetsClient {
     ...
     */
    public MavenAGIHttpResponse<InitiateAssetUploadResponse> initiateUpload(InitiateAssetUploadRequest request) {
        return initiateUpload(request, null);
    }
     ...
     * Returns a pre-signed URL for direct file upload and an asset ID for subsequent operations.
     */
    public MavenAGIHttpResponse<InitiateAssetUploadResponse> initiateUpload(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MavenAGIHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), InitiateAssetUploadResponse.class),
                        response);
            }
     ...
     */
    public MavenAGIHttpResponse<Void> commitUpload(String assetReferenceId) {
        return commitUpload(assetReferenceId, CommitAssetUploadRequest.builder().build());
    }
     ...
     * Updates the asset status and makes it available for use.
     */
    public MavenAGIHttpResponse<Void> commitUpload(String assetReferenceId, CommitAssetUploadRequest request) {
        return commitUpload(assetReferenceId, request, null);
    }
     ...
     * Updates the asset status and makes it available for use.
     */
    public MavenAGIHttpResponse<Void> commitUpload(
            String assetReferenceId, CommitAssetUploadRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v1/assets")
                .addPathSegment(assetReferenceId)
                .addPathSegments("commit")
                .build();
        RequestBody body;
        try {
            body = RequestBody.create(
