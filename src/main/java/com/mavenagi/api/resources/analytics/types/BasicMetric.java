...
@JsonDeserialize(builder = BasicMetric.Builder.class)
public final class BasicMetric implements IBasicMetric {
    private final ConversationField targetField;

    private final Map<String, Object> additionalProperties;

    private BasicMetric(ConversationField targetField, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BasicMetric && equalTo((BasicMetric) other);
    }
    ...
    private boolean equalTo(BasicMetric other) {
    ...
    public interface TargetFieldStage {
        ...
        Builder from(BasicMetric other);
    }
    ...
    public static final class Builder implements TargetFieldStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(BasicMetric other) {
        ...
        @java.lang.Override
        public BasicMetric build() {
            return new BasicMetric(targetField, additionalProperties);
        }
    }
}
