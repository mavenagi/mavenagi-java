...
public final class ConversationResponse implements IConversationBase {
    ...
    /**
     * @return An analysis of the conversation.
     */
    ...
    public interface AnalysisStage {
        _FinalStage analysis(@NotNull ConversationAnalysis analysis);
    }
    ...
    public static final class Builder implements ConversationIdStage, AnalysisStage, _FinalStage {
        ...
        /**
         * <p>An analysis of the conversation.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @java.lang.Override
        @JsonSetter("analysis")
        public _FinalStage analysis(@NotNull ConversationAnalysis analysis) {
