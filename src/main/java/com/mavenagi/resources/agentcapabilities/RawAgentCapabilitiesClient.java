...
public class RawAgentCapabilitiesClient {
    protected final ClientOptions clientOptions;

    public RawAgentCapabilitiesClient(ClientOptions clientOptions) {
     ...
     */
    public MavenAGIHttpResponse<ListAgentCapabilitiesResponse> list() {
     ...
     * List all capabilities for an agent.
     */
    public MavenAGIHttpResponse<ListAgentCapabilitiesResponse> list(AgentCapabilityListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MavenAGIHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), ListAgentCapabilitiesResponse.class),
                        response);
            }
    ...
    public MavenAGIHttpResponse<AgentCapability> get(String integrationId, String capabilityId) {
        return get(integrationId, capabilityId, null);
    }

    public MavenAGIHttpResponse<AgentCapability> get(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MavenAGIHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), AgentCapability.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            try {
                switch (response.code()) {
    ...
    public MavenAGIHttpResponse<AgentCapability> patch(String integrationId, String capabilityId) {
        return patch(
                integrationId,
                capabilityId,
    ...
    public MavenAGIHttpResponse<AgentCapability> patch(
     ...
     */
    public MavenAGIHttpResponse<ExecuteCapabilityResponse> execute(String integrationId, String capabilityId) {
        return execute(
     ...
     * Execute an action capability.
     */
    public MavenAGIHttpResponse<ExecuteCapabilityResponse> execute(
    ...
    public MavenAGIHttpResponse<ExecuteCapabilityResponse> execute(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new MavenAGIHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), ExecuteCapabilityResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            try {
