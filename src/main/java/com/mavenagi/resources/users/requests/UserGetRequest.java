...
public final class UserGetRequest {
    ...
    /**
     * @return The App ID of the app user to get. If not provided the ID of the calling app will be used.
     */
    @JsonProperty("appId")
    ...
    public static final class Builder {
        ...
        /**
         * <p>The App ID of the app user to get. If not provided the ID of the calling app will be used.</p>
         */
