 ...
 */
package com.mavenagi.api.resources.translations;
...
import com.mavenagi.api.resources.translations.types.TranslationRequest;
import com.mavenagi.api.resources.translations.types.TranslationResponse;
    ...
    public TranslationResponse translate(TranslationRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), TranslationResponse.class);
            }
