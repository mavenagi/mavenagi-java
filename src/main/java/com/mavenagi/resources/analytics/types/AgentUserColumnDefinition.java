...
@JsonDeserialize(builder = AgentUserColumnDefinition.Builder.class)
public final class AgentUserColumnDefinition implements IColumnDefinitionBase {
    private final String header;

    private final AgentUserMetric metric;

    private final Map<String, Object> additionalProperties;

    private AgentUserColumnDefinition(String header, AgentUserMetric metric, Map<String, Object> additionalProperties) {
        this.header = header;
        this.metric = metric;
     ...
     */
    @JsonProperty("metric")
    public AgentUserMetric getMetric() {
        return metric;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AgentUserColumnDefinition && equalTo((AgentUserColumnDefinition) other);
    }
    ...
    private boolean equalTo(AgentUserColumnDefinition other) {
    ...
    public interface HeaderStage {
        ...
        Builder from(AgentUserColumnDefinition other);
    }
    ...
    public interface MetricStage {
         ...
         */
        _FinalStage metric(@NotNull AgentUserMetric metric);
    }

    public interface _FinalStage {
        AgentUserColumnDefinition build();
    }
    ...
    public static final class Builder implements HeaderStage, MetricStage, _FinalStage {
        ...
        private AgentUserMetric metric;
        ...
        @java.lang.Override
        public Builder from(AgentUserColumnDefinition other) {
        ...
        @java.lang.Override
        @JsonSetter("metric")
        public _FinalStage metric(@NotNull AgentUserMetric metric) {
            this.metric = Objects.requireNonNull(metric, "metric must not be null");
            return this;
        }

        @java.lang.Override
        public AgentUserColumnDefinition build() {
            return new AgentUserColumnDefinition(header, metric, additionalProperties);
        }
    }
}
