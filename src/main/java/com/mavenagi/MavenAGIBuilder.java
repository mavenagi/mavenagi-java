...
public class MavenAGIBuilder {
     ...
     */
    public MavenAGIBuilder addHeader(String name, String value) {
    ...
    protected void setAuthentication(ClientOptions.Builder builder) {
        if (this.appId != null && this.appSecret != null) {
            String unencodedToken = this.appId + ":" + this.appSecret;
     ...
     */
    protected void setCustomHeaders(ClientOptions.Builder builder) {
        builder.addHeader("X-Organization-Id", this.organizationId);
        builder.addHeader("X-Agent-Id", this.agentId);
    }
    ...
    public MavenAGI build() {
        ...
        return new MavenAGI(buildClientOptions());
    }
}
