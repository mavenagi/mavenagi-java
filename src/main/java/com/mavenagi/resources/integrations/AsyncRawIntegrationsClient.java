...
public class AsyncRawIntegrationsClient {
     ...
     */
    public CompletableFuture<MavenAGIHttpResponse<Void>> update(String organizationId, String integrationId) {
        return update(
                organizationId,
                integrationId,
     ...
     * Update an integration.
     */
    public CompletableFuture<MavenAGIHttpResponse<Void>> update(
