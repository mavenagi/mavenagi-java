...
@JsonDeserialize(builder = Median.Builder.class)
public final class Median implements IBasicMetric {
    private final ConversationField targetField;

    private final Map<String, Object> additionalProperties;

    private Median(ConversationField targetField, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof Median && equalTo((Median) other);
    }
    ...
    private boolean equalTo(Median other) {
    ...
    public static final class Builder implements TargetFieldStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(Median other) {
        ...
        @java.lang.Override
        public Median build() {
            return new Median(targetField, additionalProperties);
        }
    }
}
