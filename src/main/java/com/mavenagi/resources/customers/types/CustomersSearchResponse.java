...
@JsonDeserialize(builder = CustomersSearchResponse.Builder.class)
public final class CustomersSearchResponse implements IPage {
    ...
    private CustomersSearchResponse(
            int number,
            int size,
            long totalElements,
            int totalPages,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CustomersSearchResponse && equalTo((CustomersSearchResponse) other);
    }
    ...
    private boolean equalTo(CustomersSearchResponse other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.number, this.size, this.totalElements, this.totalPages, this.customers);
    }
    ...
    public interface NumberStage {
        ...
        Builder from(CustomersSearchResponse other);
    }
    ...
    public interface _FinalStage {
        CustomersSearchResponse build();

        _FinalStage customers(List<CustomerResponse> customers);

        _FinalStage addCustomers(CustomerResponse customers);

        _FinalStage addAllCustomers(List<CustomerResponse> customers);
    }
    ...
    public static final class Builder
        ...
        @java.lang.Override
        public Builder from(CustomersSearchResponse other) {
        ...
        @java.lang.Override
        public _FinalStage addAllCustomers(List<CustomerResponse> customers) {
            if (customers != null) {
        ...
        @java.lang.Override
        public _FinalStage addCustomers(CustomerResponse customers) {
        ...
        public _FinalStage customers(List<CustomerResponse> customers) {
        ...
        @java.lang.Override
        public CustomersSearchResponse build() {
            return new CustomersSearchResponse(
                    number, size, totalElements, totalPages, customers, additionalProperties);
        }
    }
}
