...
public final class ConversationPrecondition {
    ...
    public static ConversationPrecondition conversationState(ConversationStatePrecondition value) {
        return new ConversationPrecondition(new ConversationStateValue(value));
    }

    public static ConversationPrecondition conversationMode(ConversationModePrecondition value) {
        return new ConversationPrecondition(new ConversationModeValue(value));
    }
