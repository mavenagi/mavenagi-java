...
public final class Sum implements IBasicMetric {
    private final ConversationField targetField;

    private final Map<String, Object> additionalProperties;

    private Sum(ConversationField targetField, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof Sum && equalTo((Sum) other);
    }
    ...
    private boolean equalTo(Sum other) {
    ...
    public static final class Builder implements TargetFieldStage, _FinalStage {
        ...
        @java.lang.Override
        public Sum build() {
            return new Sum(targetField, additionalProperties);
        }
    }
}
