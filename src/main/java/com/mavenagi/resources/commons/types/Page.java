...
public final class Page implements IPage {
    ...
    private Page(int number, int size, long totalElements, int totalPages, Map<String, Object> additionalProperties) {
        this.number = number;
        this.size = size;
    ...
    public static final class Builder
        ...
        @java.lang.Override
        public Page build() {
            return new Page(number, size, totalElements, totalPages, additionalProperties);
        }
    }
}
