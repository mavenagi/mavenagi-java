...
@JsonDeserialize(builder = ConversationMax.Builder.class)
public final class ConversationMax implements IConversationNumericMetric {
    private final NumericConversationField targetField;

    private final Map<String, Object> additionalProperties;

    private ConversationMax(NumericConversationField targetField, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConversationMax && equalTo((ConversationMax) other);
    }
    ...
    private boolean equalTo(ConversationMax other) {
    ...
    public interface TargetFieldStage {
        ...
        Builder from(ConversationMax other);
    }

    public interface _FinalStage {
        ConversationMax build();
    }
    ...
    public static final class Builder implements TargetFieldStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ConversationMax other) {
        ...
        @java.lang.Override
        public ConversationMax build() {
            return new ConversationMax(targetField, additionalProperties);
        }
    }
}
