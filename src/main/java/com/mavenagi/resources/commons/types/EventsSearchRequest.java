...
@JsonDeserialize(builder = EventsSearchRequest.Builder.class)
public final class EventsSearchRequest implements IBasePaginatedRequest {
    ...
    private final Optional<EventField> sort;

    private final Optional<EventFilter> filter;

    private final Map<String, Object> additionalProperties;

    private EventsSearchRequest(
            Optional<Integer> page,
            Optional<Integer> size,
            Optional<Boolean> sortDesc,
            Optional<EventField> sort,
            Optional<EventFilter> filter,
    ...
    @JsonProperty("sort")
    public Optional<EventField> getSort() {
        return sort;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EventsSearchRequest && equalTo((EventsSearchRequest) other);
    }
    ...
    private boolean equalTo(EventsSearchRequest other) {
    ...
    public static final class Builder {
        ...
        private Optional<EventField> sort = Optional.empty();

        private Optional<EventFilter> filter = Optional.empty();
        ...
        public Builder from(EventsSearchRequest other) {
            page(other.getPage());
            size(other.getSize());
        ...
        public Builder sort(Optional<EventField> sort) {
            this.sort = sort;
            return this;
        }

        public Builder sort(EventField sort) {
            this.sort = Optional.ofNullable(sort);
            return this;
        }

        @JsonSetter(value = "filter", nulls = Nulls.SKIP)
        public Builder filter(Optional<EventFilter> filter) {
            this.filter = filter;
            return this;
        }
        ...
        public EventsSearchRequest build() {
            return new EventsSearchRequest(page, size, sortDesc, sort, filter, additionalProperties);
        }
    }
}
