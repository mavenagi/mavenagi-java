...
public class AsyncRawVoiceClient {
     ...
     */
    public CompletableFuture<MavenAGIHttpResponse<VoiceSessionTokenResponse>> sessionToken(
            VoiceSessionTokenRequest request) {
    ...
    public CompletableFuture<MavenAGIHttpResponse<VoiceSessionTokenResponse>> sessionToken(
        ...
        CompletableFuture<MavenAGIHttpResponse<VoiceSessionTokenResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MavenAGIHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), VoiceSessionTokenResponse.class),
                                response));
                        return;
                    }
