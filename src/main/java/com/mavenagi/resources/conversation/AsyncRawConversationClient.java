...
public class AsyncRawConversationClient {
     ...
     * The CSV format may change over time and should not be relied upon by code consumers.</p>
     */
    public CompletableFuture<MavenAGIHttpResponse<InputStream>> export(ConversationsSearchRequest request) {
     ...
     */
    public CompletableFuture<MavenAGIHttpResponse<Void>> importSimulations(File file, SimulationImportRequest request) {
        return importSimulations(file, request, null);
    }
     ...
     * Most API callers should create simulations programmatically to allow for more flexibility.</p>
     */
    public CompletableFuture<MavenAGIHttpResponse<Void>> importSimulations(
            File file, SimulationImportRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v1/conversations")
                .addPathSegments("import_simulations")
                .build();
        ...
        try {
            ...
            if (request.getResponseConfig().isPresent()) {
                body.addFormDataPart(
                        "responseConfig",
                        ObjectMappers.JSON_MAPPER.writeValueAsString(
                                request.getResponseConfig().get()));
            }
        } catch (Exception e) {
