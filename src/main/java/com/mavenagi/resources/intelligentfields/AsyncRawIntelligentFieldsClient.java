...
public class AsyncRawIntelligentFieldsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawIntelligentFieldsClient(ClientOptions clientOptions) {
    ...
    public CompletableFuture<MavenAGIHttpResponse<IntelligentFieldResponse>> createOrUpdate(
        ...
        CompletableFuture<MavenAGIHttpResponse<IntelligentFieldResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new MavenAGIHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), IntelligentFieldResponse.class),
                                response));
                        return;
                    }
    ...
    public CompletableFuture<MavenAGIHttpResponse<IntelligentFieldDetailResponse>> get(
        ...
        CompletableFuture<MavenAGIHttpResponse<IntelligentFieldDetailResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
     ...
     */
    public CompletableFuture<MavenAGIHttpResponse<IntelligentFieldResponse>> delete(String fieldReferenceId) {
     ...
     * <p>Deleted fields cannot be modified.</p>
     */
    public CompletableFuture<MavenAGIHttpResponse<IntelligentFieldResponse>> delete(
    ...
    public CompletableFuture<MavenAGIHttpResponse<IntelligentFieldValueSearchResponse>> searchValues(
        ...
        CompletableFuture<MavenAGIHttpResponse<IntelligentFieldValueSearchResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
