...
public final class ConversationTableRequest implements IConversationAnalyticsRequest {
    ...
    public static final class Builder {
        ...
        /**
         * <p>Defines the time interval for grouping data. If specified, data is grouped accordingly  based on the time they were created. Example: If set to &quot;DAY,&quot; data will be aggregated by day.</p>
         */
        ...
        /**
         * <p>Specifies the metrics to be displayed as columns. Column headers act as keys, with computed metric values as their mapped values. There needs to be at least one column definition in the table request.</p>
         */
