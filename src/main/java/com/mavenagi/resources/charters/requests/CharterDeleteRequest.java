...
@JsonDeserialize(builder = CharterDeleteRequest.Builder.class)
public final class CharterDeleteRequest {
    ...
    /**
     * @return The App ID of the charter to delete. If not provided, the ID of the calling app will be used.
     */
    @JsonProperty("appId")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CharterDeleteRequest && equalTo((CharterDeleteRequest) other);
    }
    ...
    private boolean equalTo(CharterDeleteRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CharterDeleteRequest other) {
        ...
        /**
         * <p>The App ID of the charter to delete. If not provided, the ID of the calling app will be used.</p>
         */
        ...
        public CharterDeleteRequest build() {
            return new CharterDeleteRequest(appId, variantReferenceId, variantAppId, additionalProperties);
        }
    }
}
