...
@JsonDeserialize(builder = BaseSearchRequest.Builder.class)
public final class BaseSearchRequest implements IBaseSearchRequest, IBasePaginatedRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BaseSearchRequest && equalTo((BaseSearchRequest) other);
    }
    ...
    private boolean equalTo(BaseSearchRequest other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.sortId, this.page, this.size, this.sortDesc);
    }
    ...
    public static final class Builder {
        ...
        public Builder from(BaseSearchRequest other) {
        ...
        public BaseSearchRequest build() {
            return new BaseSearchRequest(sortId, page, size, sortDesc, additionalProperties);
        }
    }
}
