...
public class RawKnowledgeClient {
     ...
     */
    public MavenAGIHttpResponse<Void> refreshKnowledgeBase(String knowledgeBaseReferenceId) {
     ...
     * They can also be refreshed on demand by calling this endpoint.</p>
     */
    public MavenAGIHttpResponse<Void> refreshKnowledgeBase(
     ...
     */
    public MavenAGIHttpResponse<Void> rollbackKnowledgeBaseVersion(String knowledgeBaseReferenceId) {
     ...
     * Rolls the knowledge base back to its previous published version.
     */
    public MavenAGIHttpResponse<Void> rollbackKnowledgeBaseVersion(
     ...
     */
    public MavenAGIHttpResponse<KnowledgeBaseVersion> updateKnowledgeBaseVersionProgress(
     ...
     */
    public MavenAGIHttpResponse<KnowledgeDocumentResponse> patchKnowledgeDocument(
