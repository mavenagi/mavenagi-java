...
public final class ConversationChartRequest {
    ...
    public static ConversationChartRequest pieChart(ConversationPieChartRequest value) {
        return new ConversationChartRequest(new PieChartValue(value));
    }

    public static ConversationChartRequest dateHistogram(ConversationDateHistogramRequest value) {
        return new ConversationChartRequest(new DateHistogramValue(value));
    }

    public static ConversationChartRequest barChart(ConversationBarChartRequest value) {
    ...
    public Optional<ConversationPieChartRequest> getPieChart() {
        if (isPieChart()) {
    ...
    public Optional<ConversationDateHistogramRequest> getDateHistogram() {
        if (isDateHistogram()) {
    ...
    public Optional<ConversationBarChartRequest> getBarChart() {
        if (isBarChart()) {
    ...
    public interface Visitor<T> {
        T visitPieChart(ConversationPieChartRequest pieChart);

        T visitDateHistogram(ConversationDateHistogramRequest dateHistogram);

        T visitBarChart(ConversationBarChartRequest barChart);
    ...
    private static final class PieChartValue implements Value {
        @JsonUnwrapped
        private ConversationPieChartRequest value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private PieChartValue() {}

        private PieChartValue(ConversationPieChartRequest value) {
            this.value = value;
        }
    ...
    private static final class DateHistogramValue implements Value {
        @JsonUnwrapped
        private ConversationDateHistogramRequest value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private DateHistogramValue() {}

        private DateHistogramValue(ConversationDateHistogramRequest value) {
            this.value = value;
        }
    ...
    private static final class BarChartValue implements Value {
        @JsonUnwrapped
        private ConversationBarChartRequest value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private BarChartValue() {}

        private BarChartValue(ConversationBarChartRequest value) {
            this.value = value;
        }
