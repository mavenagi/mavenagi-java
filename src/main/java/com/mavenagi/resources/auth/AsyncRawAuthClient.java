...
public class AsyncRawAuthClient {
     ...
     */
    public CompletableFuture<MavenAGIHttpResponse<SessionTokenResponse>> sessionToken(SessionTokenRequest request) {
     ...
     * you don’t want to expose your API key.
     */
    public CompletableFuture<MavenAGIHttpResponse<SessionTokenResponse>> sessionToken(
            SessionTokenRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v1/auth")
        ...
        CompletableFuture<MavenAGIHttpResponse<SessionTokenResponse>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new MavenAGIHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), SessionTokenResponse.class),
                                response));
                        return;
                    }
