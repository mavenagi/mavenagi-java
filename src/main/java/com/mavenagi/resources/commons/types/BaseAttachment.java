...
@JsonDeserialize(builder = BaseAttachment.Builder.class)
public final class BaseAttachment implements IBaseAttachment {
    ...
    private BaseAttachment(String type, Optional<String> name, Map<String, Object> additionalProperties) {
        this.type = type;
        this.name = name;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BaseAttachment && equalTo((BaseAttachment) other);
    }
    ...
    private boolean equalTo(BaseAttachment other) {
    ...
    public interface TypeStage {
        ...
        Builder from(BaseAttachment other);
    }

    public interface _FinalStage {
        BaseAttachment build();
    ...
    public static final class Builder implements TypeStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(BaseAttachment other) {
            type(other.getType());
            name(other.getName());
            return this;
        }
        ...
        @java.lang.Override
        public BaseAttachment build() {
            return new BaseAttachment(type, name, additionalProperties);
        }
    }
}
