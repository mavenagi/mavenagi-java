...
@JsonDeserialize(builder = ConversationMin.Builder.class)
public final class ConversationMin implements IConversationNumericMetric {
    private final NumericConversationField targetField;

    private final Map<String, Object> additionalProperties;

    private ConversationMin(NumericConversationField targetField, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConversationMin && equalTo((ConversationMin) other);
    }
    ...
    private boolean equalTo(ConversationMin other) {
    ...
    public interface TargetFieldStage {
        ...
        Builder from(ConversationMin other);
    }

    public interface _FinalStage {
        ConversationMin build();
    }
    ...
    public static final class Builder implements TargetFieldStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ConversationMin other) {
        ...
        @java.lang.Override
        public ConversationMin build() {
            return new ConversationMin(targetField, additionalProperties);
        }
    }
}
