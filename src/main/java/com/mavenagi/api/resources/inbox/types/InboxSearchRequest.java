...
import com.mavenagi.api.resources.commons.types.InboxItemStatus;
import com.mavenagi.api.resources.commons.types.InboxItemType;
...
public final class InboxSearchRequest implements IBaseInboxSearchRequest {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.page, this.size, this.statuses, this.type, this.createdAfter, this.createdBefore);
    }
    ...
    public static final class Builder {
        ...
        public InboxSearchRequest build() {
            return new InboxSearchRequest(
                    page, size, statuses, type, createdAfter, createdBefore, additionalProperties);
        }
    }
}
