...
@JsonDeserialize(builder = ActionProperties.Builder.class)
public final class ActionProperties implements IActionProperties {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ActionProperties && equalTo((ActionProperties) other);
    }
    ...
    private boolean equalTo(ActionProperties other) {
    ...
    public interface UserInteractionRequiredStage {
         ...
         */
        _FinalStage userInteractionRequired(boolean userInteractionRequired);

        Builder from(ActionProperties other);
    }

    public interface _FinalStage {
        ActionProperties build();
    ...
    public static final class Builder implements UserInteractionRequiredStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ActionProperties other) {
