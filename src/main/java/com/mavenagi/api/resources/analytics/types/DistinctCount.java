...
@JsonDeserialize(builder = DistinctCount.Builder.class)
public final class DistinctCount implements IBasicMetric {
    private final ConversationField targetField;

    private final Map<String, Object> additionalProperties;

    private DistinctCount(ConversationField targetField, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DistinctCount && equalTo((DistinctCount) other);
    }
    ...
    private boolean equalTo(DistinctCount other) {
    ...
    public interface TargetFieldStage {
        ...
        Builder from(DistinctCount other);
    }
    ...
    public static final class Builder implements TargetFieldStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DistinctCount other) {
        ...
        @java.lang.Override
        public DistinctCount build() {
            return new DistinctCount(targetField, additionalProperties);
        }
    }
}
