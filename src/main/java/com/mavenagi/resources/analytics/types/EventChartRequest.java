...
public final class EventChartRequest {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private EventChartRequest(Value value) {
        this.value = value;
    }
    ...
    public static EventChartRequest pieChart(EventPieChartRequest value) {
        return new EventChartRequest(new PieChartValue(value));
    }

    public static EventChartRequest dateHistogram(EventDateHistogramRequest value) {
        return new EventChartRequest(new DateHistogramValue(value));
    }

    public static EventChartRequest barChart(EventBarChartRequest value) {
        return new EventChartRequest(new BarChartValue(value));
    }
    ...
    public Optional<EventPieChartRequest> getPieChart() {
        if (isPieChart()) {
    ...
    public Optional<EventDateHistogramRequest> getDateHistogram() {
        if (isDateHistogram()) {
    ...
    public Optional<EventBarChartRequest> getBarChart() {
        if (isBarChart()) {
    ...
    public interface Visitor<T> {
        T visitPieChart(EventPieChartRequest pieChart);

        T visitDateHistogram(EventDateHistogramRequest dateHistogram);

        T visitBarChart(EventBarChartRequest barChart);
    ...
    private static final class PieChartValue implements Value {
        @JsonUnwrapped
        private EventPieChartRequest value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private PieChartValue() {}

        private PieChartValue(EventPieChartRequest value) {
            this.value = value;
        }
        ...
        public String toString() {
            return "EventChartRequest{" + "value: " + value + "}";
        }
    }
    ...
    private static final class DateHistogramValue implements Value {
        @JsonUnwrapped
        private EventDateHistogramRequest value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private DateHistogramValue() {}

        private DateHistogramValue(EventDateHistogramRequest value) {
            this.value = value;
        }
    ...
    private static final class BarChartValue implements Value {
        @JsonUnwrapped
        private EventBarChartRequest value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private BarChartValue() {}

        private BarChartValue(EventBarChartRequest value) {
            this.value = value;
        }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "EventChartRequest{" + "type: " + type + ", value: " + value + "}";
        }
    }
}
