...
@JsonDeserialize(builder = NovelSystemEvent.Builder.class)
public final class NovelSystemEvent implements INovelSystemEventNoId, IEventBaseNoId {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof NovelSystemEvent && equalTo((NovelSystemEvent) other);
    }
    ...
    private boolean equalTo(NovelSystemEvent other) {
    ...
    public interface EventNameStage {
        ...
        Builder from(NovelSystemEvent other);
    }
    ...
    public static final class Builder implements EventNameStage, IdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(NovelSystemEvent other) {
        ...
        @java.lang.Override
        public NovelSystemEvent build() {
            return new NovelSystemEvent(
