...
import com.mavenagi.api.resources.analyticscommons.types.TimeInterval;
...
public final class ConversationTableRequest implements IConversationAnalyticsRequest {
    ...
    private final List<GroupBy> fieldGroupings;
    ...
    public List<GroupBy> getFieldGroupings() {
    ...
    public static final class Builder {
        ...
        private List<GroupBy> fieldGroupings = new ArrayList<>();
        ...
        public Builder fieldGroupings(List<GroupBy> fieldGroupings) {
            this.fieldGroupings.clear();
            this.fieldGroupings.addAll(fieldGroupings);
            return this;
        }

        public Builder addFieldGroupings(GroupBy fieldGroupings) {
            this.fieldGroupings.add(fieldGroupings);
            return this;
        }

        public Builder addAllFieldGroupings(List<GroupBy> fieldGroupings) {
            this.fieldGroupings.addAll(fieldGroupings);
            return this;
        }
        ...
        public Builder addColumnDefinitions(ColumnDefinition columnDefinitions) {
            this.columnDefinitions.add(columnDefinitions);
            return this;
        }

        public Builder addAllColumnDefinitions(List<ColumnDefinition> columnDefinitions) {
            this.columnDefinitions.addAll(columnDefinitions);
            return this;
        }
