...
@JsonDeserialize(builder = ConversationSum.Builder.class)
public final class ConversationSum implements IConversationNumericMetric {
    private final NumericConversationField targetField;

    private final Map<String, Object> additionalProperties;

    private ConversationSum(NumericConversationField targetField, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ConversationSum && equalTo((ConversationSum) other);
    }
    ...
    private boolean equalTo(ConversationSum other) {
    ...
    public interface TargetFieldStage {
        ...
        Builder from(ConversationSum other);
    }

    public interface _FinalStage {
        ConversationSum build();
    }
    ...
    public static final class Builder implements TargetFieldStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ConversationSum other) {
        ...
        @java.lang.Override
        public ConversationSum build() {
            return new ConversationSum(targetField, additionalProperties);
        }
    }
}
