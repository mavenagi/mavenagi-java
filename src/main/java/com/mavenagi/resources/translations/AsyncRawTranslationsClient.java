...
public class AsyncRawTranslationsClient {
     ...
     */
    public CompletableFuture<MavenAGIHttpResponse<TranslationResponse>> translate(TranslationRequest request) {
     ...
     * Translate text from one language to another
     */
    public CompletableFuture<MavenAGIHttpResponse<TranslationResponse>> translate(
            TranslationRequest request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("v1/translations")
        ...
        CompletableFuture<MavenAGIHttpResponse<TranslationResponse>> future = new CompletableFuture<>();
                ...
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new MavenAGIHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), TranslationResponse.class),
                                response));
                        return;
                    }
